  ...
  {[...Array(5)].map((_, index) => (
    <Box
      ...
      sx={{
        ...
        width: 16,
        height: 16,
         background: `radial-gradient(${theme.palette.primary.main}${mode === 'dark' ? '30' : '10'}, transparent)`,
        borderRadius: '50%',
        opacity: 0.3,
        top: `${Math.random() * 100}%`,
...
<Box sx={{ 
  ...
  {[...Array(6)].map((_, index) => (
    <Box key={index} sx={{
      ...
      height: 40,
       background: `linear-gradient(
    145deg,
    ${theme.palette.primary.main}${mode === 'dark' ? '20' : '08'},
    ${theme.palette.secondary.main}${mode === 'dark' ? '20' : '08'},
    ${theme.palette.background.paper}
  )`,
  border: `1px solid ${theme.palette.primary.main}${mode === 'dark' ? '30' : '10'}`,
  boxShadow: `0 8px 32px ${theme.palette.primary.main}${mode === 'dark' ? '20' : '08'}`,
      borderRadius: '50%',
      animation: `float ${8 + index}s infinite ease-in-out`,
      top: `${Math.random() * 100}%`,
      left: `${Math.random() * 100}%`,
  ...
  '&::before': {
    background: `linear-gradient(
      120deg,
      transparent,
      rgba(${mode === 'dark' ? '255,255,255' : '0,0,0'},0.3),
      transparent
    )`
  },
